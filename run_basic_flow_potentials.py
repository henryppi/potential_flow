...
cs111 = ax11.contour(xx,yy,phi,levels=10,colors='k',linestyles='dashed',linewidths=2)
cs112 = ax11.contour(xx,yy,psi,levels=10,colors='k',linestyles='solid',linewidths=2)
...
cs121 = ax12.contour(xx,yy,phi_complex,levels=10,colors='k',linestyles='dashed',linewidths=2)
cs122 = ax12.contour(xx,yy,psi_complex,levels=10,colors='k',linestyles='solid',linewidths=2)
...
xx = rr * np.cos(aa)
yy = rr * np.sin(aa)
cs1 = ax2[0,0].contour(xx,yy,phi_pol,levels=12,colors='k',linestyles='dashed',linewidths=2)
cs2 = ax2[0,0].contour(xx,yy,psi_pol,levels=12,colors='k',linestyles='solid',linewidths=2)
...
xx = rr * np.cos(aa)
yy = rr * np.sin(aa)
cs1 = ax2[0,1].contour(xx,yy,phi_pol,levels=12,colors='k',linestyles='dashed',linewidths=2)
cs2 = ax2[0,1].contour(xx,yy,psi_pol,levels=12,colors='k',linestyles='solid',linewidths=2)
px = 3*np.cos(theta)
py = 3*np.sin(theta)
...
xx = rr * np.cos(aa)
yy = rr * np.sin(aa)
cs1 = ax2[1,0].contour(xx,yy,phi_pol,levels=12,colors='k',linestyles='dashed',linewidths=2)
cs2 = ax2[1,0].contour(xx,yy,psi_pol,levels=12,colors='k',linestyles='solid',linewidths=2)
px = 3*np.cos(theta)
py = 3*np.sin(theta)
...
xx = rr * np.cos(aa)
yy = rr * np.sin(aa)
cs1 = ax2[1,1].contour(xx,yy,phi_pol,levels=12,colors='k',linestyles='dashed',linewidths=2)
cs2 = ax2[1,1].contour(xx,yy,psi_pol,levels=12,colors='k',linestyles='solid',linewidths=2)
px = 3*np.cos(theta)
py = 3*np.sin(theta)
...
xx = rr * np.cos(aa)
yy = rr * np.sin(aa)
cs1 = ax3[0].contour(xx,yy,phi_pol,levels=12,colors='k',linestyles='dashed',linewidths=2)
cs2 = ax3[0].contour(xx,yy,psi_pol,levels=12,colors='k',linestyles='solid',linewidths=2)
...
ax3[0].axis('equal')
ax3[0].set_title('wedge angle $\Theta=180^\circ$')
...
xx = rr * np.cos(aa)
yy = rr * np.sin(aa)
cs1 = ax3[1].contour(xx,yy,psi_pol,levels=12,colors='k',linestyles='dashed',linewidths=2)
cs2 = ax3[1].contour(xx,yy,phi_pol,levels=12,colors='k',linestyles='solid',linewidths=2)
px1 = 3*np.cos(theta)
py1 = 3*np.sin(theta)
...
ax3[1].axis('equal')
ax3[1].set_title('wedge angle $\Theta=180^\circ$')
...
xx = rr * np.cos(aa)
yy = rr * np.sin(aa)
cs1 = ax4[0].contour(xx,yy,phi_pol,levels=12,colors='k',linestyles='dashed',linewidths=2)
cs2 = ax4[0].contour(xx,yy,psi_pol,levels=12,colors='k',linestyles='solid',linewidths=2)
...
cs1 = ax4[1].contour(xx,yy,phi_pol,levels=12,colors='k',linestyles='dashed',linewidths=2)
cs2 = ax4[1].contour(xx,yy,psi_pol,levels=12,colors='k',linestyles='solid',linewidths=2)
