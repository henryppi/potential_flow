...
circle = 1.1*R*np.exp(ang*1j)+cx+cy*1j
...
fig1, [ax0,ax1] = plt.subplots(2,1,figsize=(6,12),facecolor='w',frameon=False)
...
ax1.set_xlim([-3,3])
ax1.set_ylim([-3,3])
plt.savefig("./images/wing_profile.png",bbox_inches='tight',dpi=200)
plt.show()
